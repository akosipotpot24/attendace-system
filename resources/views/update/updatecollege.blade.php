...
<form action="/editcollege1/{{$student->borrowernumber}}" method="POST">
@csrf
@method('PUT')
...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"> UPDATE STUDENTS  <a href="/college" class="btn btn-danger float-end">Back</a> </div>
